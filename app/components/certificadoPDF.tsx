  ...
  C175.64,51.72,176.11,51.62,176.56,51.44"/>
        ...
        <View style={styles.sectionContentTable} >
          ...
          <View style={styles.sectionContentTableColumnBorder}  >
            ...
            {props.certificado.tramite.ddjjObras.map((o: DDJJObra) => <Text style={{ margin: 5 }} >{numeral(o.montoInicial).format('$0,0.00')}</Text>)}
          </View>
          <View style={styles.sectionContentTableColumnBorder}  >
            <Text style={styles.sectionEtiquetaTable}>Saldo</Text>
            {props.certificado.tramite.ddjjObras.map((o: DDJJObra) => <Text style={{ margin: 5 }} >{numeral(calcularSaldoObra(o)).format('$0,0.00')}</Text>)}
