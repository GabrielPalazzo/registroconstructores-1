...
export default () => (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.sectionContentHead} >
        <View style={styles.sectionContentHeadColumn3}  >
          <Text style={styles.sectionEtiqueta}  >ECOPRENEUR S.A.</Text>
          <Text  >Registrado como:<Text style={styles.sectionEtiqueta}>CONSTRUCTORA</Text>  </Text>
          <Text  >Estado:  <Text style={styles.sectionEtiqueta}>INSCRIPTO CON ACTUALIZACIÓN</Text>  </Text>
          <Text  >Cuit:  <Text style={styles.sectionEtiqueta}>30640972021</Text>  </Text>
        </View>
        <View style={styles.sectionContentHeadColumn2}>

          <Text style={styles.sectionH2}>Fecha de vigencia</Text>
          <Text style={styles.sectionH2}>04/2024</Text>
