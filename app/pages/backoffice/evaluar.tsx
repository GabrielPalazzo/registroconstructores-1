  ...
  return (
    ...
    <div>
      ...
      <div className="px-20 py-6  m-auto mt-6">
        <div className="text-2xl font-bold py-4 text-center"> Evaluar Trámite</div>
        <div className="text-base py-2 text-center mb-4">Ingrese su evaluación sobre el trámite a continuación.</div>
        <div className="w-2/4 m-auto mb-4 flex">
          <Card className="rounded mr-2  m-autop" style={{ width: 390, margin: 'auto', background: 'transparent', marginRight: 20 }}>
            <div className="text-sm  font-bold mb-2 ">Capacidad Economica/Financiera</div>
            <Tag color="cyan">100.0000.00,00</Tag>
          </Card>
          <Card className="rounded mr-2  m-autop" style={{ width: 390, margin: 'auto', background: 'transparent' }}>
            <div className="text-sm  font-bold  mb-2">Capacidad Técnica</div>
            <Tag color="cyan">100.0000.00,00</Tag>
          </Card>
        </div>
